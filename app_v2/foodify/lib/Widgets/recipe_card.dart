...
class RecipeCard extends StatelessWidget {
  ...
  const RecipeCard({Key? key, required this.recipe, required this.isFavorite}) : super(key: key);
                      ...
                      child: Container(
                        ...
                        child: Center(
                          ...
                          bubblesColor: const BubblesColor(
                              dotPrimaryColor: AppColors.primaryColor, dotSecondaryColor: AppColors.accentColor),
            ...
            SizedBox(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  if (recipe.diet.first != '') Tag(text: recipe.diet.join(' , '), assetIcon: 'tags/diet'),
                  if (recipe.course.first != '') Tag(text: recipe.course.join(' , '), assetIcon: 'tags/course'),
                  if (recipe.cuisine.first != '') Tag(text: recipe.cuisine.join(' , '), assetIcon: 'tags/cuisine'),
                ],
              ),
            ),
          ],
